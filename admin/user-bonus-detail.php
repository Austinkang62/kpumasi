...
<head>
    ...
    <title>회원 보너스 상세정보 - K-Pumasi Admin</title>
    <style>
    ...
    <div class="container">
        <div class="header-nav">
            ...
            <div class="nav-buttons">
                ...
                <a href="#" id="nav_bonus_detail" class="nav-button active">보너스</a>
            </div>
        </div>
    ...
    <script>
        ...
        async function loadMemberData(userId) {
            try {
                ...
                document.getElementById('nav_bonus_detail').href = `user-bonus-detail.php?user_id=${encodeURIComponent(userId)}`;
