<?php
// 자동 아바타 생성 트리거 (4시간마다 백그라운드 실행)
@include_once __DIR__ . '/includes/auto-avatar-trigger.php';
?>
<div class="dashboard-header">
    <h1>📊 Admin</h1>
    <div class="header-nav">
        <a href="/admin/pages/avatar-generator.html" class="avatar-menu-link" style="background: rgba(139, 92, 246, 0.2); border-color: rgba(139, 92, 246, 0.4); color: #a78bfa; position: relative;">
            🤖 아바타생성
        ...
        <a href="/admin/pages/pending-registrations.html" style="background: rgba(245, 158, 11, 0.2); border-color: rgba(245, 158, 11, 0.4); color: #fbbf24;">📝 가입승인</a>
        <a href="/admin/bonus-history.html" style="background: rgba(16, 185, 129, 0.2); border-color: rgba(16, 185, 129, 0.4); color: #10b981;">📊 보너스</a>
        <a href="/admin/pages/sales.html">Sales</a>
        <a href="/admin/pages/payments.html">Payments</a>
